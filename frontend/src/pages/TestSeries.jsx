...
import { fetchTests } from "../redux/slices/testsSlice";  // Import the fetchTests action
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            ...
            <div className="text-center lg:text-left lg:w-[70%] mb-12 lg:mb-0 pr-0 lg:pr-12">
              ...
              <p className="text-base lg:text-lg text-gray-600 mb-6 lg:mb-8 max-w-3xl mx-auto lg:mx-0">
                Elevate your financial career with our comprehensive, industry-leading test series. Designed by experts to maximize your success in CFA, FRM, and SCR exams. Our adaptive learning platform ensures you're always challenged at the right level.
              </p>
              <div className="flex flex-wrap justify-center lg:justify-start gap-2 lg:gap-3 text-sm lg:text-base font-medium text-gray-700">
                <span className="bg-white hover:bg-green-300 px-3 py-1 lg:px-4 lg:py-2 rounded-full shadow">Adaptive Learning</span>
                <span className="bg-white hover:bg-green-300 px-3 py-1 lg:px-4 lg:py-2 rounded-full shadow">Real-Time Analytics</span>
                <span className="bg-white hover:bg-green-300 px-3 py-1 lg:px-4 lg:py-2 rounded-full shadow">Expert Support</span>
                <span className="bg-white hover:bg-green-300 px-3 py-1 lg:px-4 lg:py-2 rounded-full shadow">Performance Tracking</span>
              </div>
            </div>
            ...
            <div className="lg:w-[30%]">
              <div className="bg-white p-6 lg:p-8 rounded-lg shadow-xl max-w-sm mx-auto">
                <h3 className="text-xl lg:text-2xl font-bold text-center text-blue-800 mb-4 lg:mb-6">Join PalsAnalytix Today</h3>
...
const TestItem = ({ test }) => {
    return (
      <div className="w-4/6 bg-blue-50 border border-blue-200 rounded-lg hover:shadow-md transition-shadow duration-300">
        <div className="p-4">
...
const TestList = () => {
    ...
    useEffect(() => {
      dispatch(fetchTests());  // Dispatch fetchTests to load the tests
    }, [dispatch]);
